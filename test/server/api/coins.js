...
lab.experiment('Coins Plugin', () => {
    ...
    lab.test('it returns an object with total and coins properties', async () => {
    ...
    lab.test('it returns the correct schema for the coins property', async () => {
        const response = await server.inject({
            method: 'GET',
            url: '/coins?total=22.20'
        });
    ...
    lab.test('it returns the minimum number of coins for a total', async () => {
        const response = await server.inject({
            method: 'GET',
            url: '/coins?total=22.20'
        });
